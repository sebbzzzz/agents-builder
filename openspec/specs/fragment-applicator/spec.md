# Spec: fragment-applicator

## Purpose

TBD — produces targeted CodeMirror transactions for enabling and disabling preset and fragment anchor blocks, using regions returned by `parseAnchors` to ensure only the affected range is modified.
