...
TBD — defines the React context that owns the CodeMirror `EditorView` instance and exposes editor operations (mount, destroy, injectOption) to descendant components without leaking the raw editor reference.
