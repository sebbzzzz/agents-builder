...
TBD — defines the Zustand store responsible for maintaining document state as an ordered array of nodes, isolated from the app store to prevent unnecessary re-renders in unrelated components.
