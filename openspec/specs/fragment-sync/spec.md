...
TBD — bridges app selection state and the CodeMirror editor by watching selection changes and dispatching fragment applicator transactions for each added or removed option, replacing `useSectionInjector`.
