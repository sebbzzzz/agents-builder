...
## Purpose
The Help/About dialog — app description copy, the footer CTAs (Start onboarding, Contact), open/close behavior, and the reusable modal primitive it is built on.
