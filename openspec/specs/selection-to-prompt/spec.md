# Spec: selection-to-prompt

## Purpose

TBD — defines how user selections are translated into prompt strings and assembled into the AGENTS.md markdown output, including grouping by category and handling of `input` type values.
